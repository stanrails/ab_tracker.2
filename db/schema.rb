...
ActiveRecord::Schema.define(version: 20170108044448) do
  ...
  create_table "programs_students", force: true do |t|
    t.integer "program_id"
    t.integer "student_id"
  end

  add_index "programs_students", ["program_id"], name: "index_programs_students_on_program_id", using: :btree
  add_index "programs_students", ["student_id"], name: "index_programs_students_on_student_id", using: :btree
